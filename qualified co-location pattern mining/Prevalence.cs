    ...
    class Prevalence
    {
        ...
        public SortedList<string, List<List<int>>> MoreSize1(SortedList<string, List<List<int>>> LastCN, SortedList<int,  SortedSet<int> > INs, double min_prev, List<int> TypeCountList, List<int> TypeinsList)
        {
            ...
            foreach (var patternitem in LastCN)
            {
                ...
                var tem=PrevalenceT(pname, k, LastCN, INs, min_prev, TypeCountList, TypeinsList);
                k++;
        ...
        public SortedList<string, List<List<int>>> PrevalenceT(string pname, int index,SortedList<string, List<List<int>>> LastCN, SortedList<int, SortedSet<int>> INs, double min_prev, List<int> TypeCountList, List<int> TypeinsList)
        {
            SortedList<string, List<List<int>>> T = new SortedList<string, List<List<int>>>();
